<?php
    ...
    $list = $db->query_get_with_options("SELECT * FROM users WHERE user_type = 2", [], ["list" => true]);
...
<head>
    ...
    <title>Learners - Sign Lingua Admin</title>
...
<body>
    ...
    <?php
        ...
        foreach ($list as $key => $user) {
            ...
            $status = "<span class='badge badge-sm badge-primary'>Active</span>";
            if($user["status"] == 2){
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="viewModalLabel">Learner Profile</h5>
