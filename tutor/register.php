...
<head>
    ...
    <title>Tutor Registration - Sign Lingua Web</title>
            ...
            <div class="login-content">
                ...
                <div class="login-form">
                    <form method="POST" action="register.php">
                        ...
                        <hr></hr>
                        <label class="input-group-textx">Resume</label>
                        <div class="form-group input-group mb-3">
                            <input type="file" class="form-control" placeholder="Upload file" name="resume" id="resume" required>
                        </div>
                        <br>
