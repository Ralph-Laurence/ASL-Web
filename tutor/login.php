<?php
    ...
    if(isset($_POST["username"]) && isset($_POST["password"])){
        ...
        $res = $db->query_get("SELECT * FROM users WHERE email = ? AND password = ? AND user_type = ? ORDER BY id DESC LIMIT 1", [$username, $password, 1]);
        if($res){
        ...
        <div class="container">
            <div class="login-content">
                <div class="login-logo">
                    <a href="./">
                        <h4 class="text-white">Sign Lingua - <span class="text-success">Tutor</span></h4>
                    </a>
                </div>
